...
public class CreationWizard extends JDialog {
	...
	public CreationWizard() {
		setMinimumSize(new Dimension(500, 264));
		...
		JLabel lblNbtx = new JLabel("Nombre max de transaction par bloc");
		springLayout.putConstraint(SpringLayout.NORTH, lblNbtx, 6, SpringLayout.SOUTH, lblBankName);
		springLayout.putConstraint(SpringLayout.WEST, lblNbtx, 0, SpringLayout.WEST, lblNombreDeBlocs);
		getContentPane().add(lblNbtx);

		JSpinner spinnerTx = new JSpinner();
		springLayout.putConstraint(SpringLayout.NORTH, spinnerTx, 6, SpringLayout.SOUTH, txtBanqueName);
		springLayout.putConstraint(SpringLayout.WEST, spinnerTx, 0, SpringLayout.WEST, spinnerUser);
		springLayout.putConstraint(SpringLayout.EAST, spinnerTx, 0, SpringLayout.EAST, spinnerDifficulty);
		spinnerTx.setValue(10);
		getContentPane().add(spinnerTx);
